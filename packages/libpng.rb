...
class Libpng < Package
  ...
  def self.build
    # Recompile to fix libpng16.so.16: undefined reference to 'inflateValidate@ZLIB_1.2.9'
    system "./configure #{CREW_OPTIONS} --disable-dependency-tracking --disable-maintainer-mode"
    system 'make'
  end
